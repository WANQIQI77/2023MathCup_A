...
results = []
# 读取Excel文件
excel_file = '第二问截断损失初始表.xlsx'  # 将 'your_excel_file.xlsx' 替换为你的Excel文件路径
...
'''
# 读取Excel文件
excel_file = '第二问遮挡损失初始表.xlsx'  # 将 'your_excel_file.xlsx' 替换为你的Excel文件路径
df = pd.read_excel(excel_file)
...
'''
# 读取Excel文件
excel_file = '第二问光线反射角初始表.xlsx'  # 将 'your_excel_file.xlsx' 替换为你的Excel文件路径
df = pd.read_excel(excel_file)
...
output_excel_file = 'result2.xlsx'
