function [shading_eff,shading_pro] = shading_eff_matrix(a_s,y_s,suntat_angle_H,suntat_angle_D,sita,mirror_l,mirror_w,mirror_height,mirror_coordinate)
...
b = mirror_height *ones(1745,1);
mirror_coordinate = [mirror_coordinate,b];            
